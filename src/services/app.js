// Your web app's Firebase configuration
  ...
  <tr>
    ...
    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <div class="text-sm font-medium leading-5 text-gray-900">${descripcion}
                </div>
    ...
    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
        <div class="text-sm leading-5 text-gray-900">${cantidad}</div>
    </td>
    <td
        class="px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">
  ...
  $('#tablaProductos').on('click', '.btnEditar', function(){
    ...
    let descripcion = $(this).closest('tr').find('td:eq(1)').text().trim();
    let cantidad = $(this).closest('tr').find('td:eq(2)').text().trim();
